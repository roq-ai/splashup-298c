...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'brand_partner.count', 'retail_partner.count', 'team_member.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('brand_partner', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'brand_partner',
          header: 'Brand Partner',
          accessorKey: 'brand_partner',
          cell: ({ row: { original: record } }: any) => record?._count?.brand_partner,
        }
      : null,
    hasAccess('retail_partner', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'retail_partner',
          header: 'Retail Partner',
          accessorKey: 'retail_partner',
          cell: ({ row: { original: record } }: any) => record?._count?.retail_partner,
        }
      : null,
