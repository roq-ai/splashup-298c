...
import { getBrandPartners, deleteBrandPartnerById, createBrandPartner } from 'apiSdk/brand-partners';
import { getRetailPartners, deleteRetailPartnerById, createRetailPartner } from 'apiSdk/retail-partners';
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createBrandPartner}
                deleteHandler={deleteBrandPartnerById}
                fetcher={getBrandPartners}
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createRetailPartner}
                deleteHandler={deleteRetailPartnerById}
                fetcher={getRetailPartners}
                entity="retail_partner"
